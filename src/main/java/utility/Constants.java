...
public class Constants {
	public static final String URL = "http://app-lb-926247714.ap-south-1.elb.amazonaws.com/\r\n"
     ...
     public static final String Username = "ramesh";
     public static final String Password = "ramesh";
     public static final String adminUsername = "Admin1";
     public static final String adminPassword = "Admin1";
     public static final String ExpectedProfilEText="ramesh@gmail.com";
    		//Airline details 
     ...
     public static final String branchCode = "SHP";
