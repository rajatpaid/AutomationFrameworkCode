...
// methods for download, search, edit , update Branch 
    ...
    public void updateBranchDetails() throws InterruptedException { 
        //this.sendkeys(branch_Code, "GYT");
    }
    ...
    public String isUpadateButtonDisplayed() {
        String  updatebutton= btnUpdate.getText();
        return updatebutton;
    }
    
    public String isBranchUpadateTextDisplayed() {
    ...
    public void enterBranchNameOnFilterPage(String name) {
        btfilter.click();
        branchNameOnFilterPage.sendKeys(name);
        okFilter.click();
    }
    //
